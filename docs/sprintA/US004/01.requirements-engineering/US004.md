...
_As competências devem ser claramente definidas e descritas
 Quando atribuir competência/s a um trabalhador.
 Deve ser possível atribuir uma ou mais competências a um colaborador de uma vez
 Em que momento atribuir essas competências._

### 1.3. Acceptance Criteria

_AC1 - Tem que ser funcionário da empresa  
 AC2 - O funcionário tem que ter pelo menos uma competência
 AC3 - Deve ser impossível atribuir competências a funcionários que não estejam na base de dados da empresa_
...
_Input - Nome do trabalhador; função do trabalhador; competêcias a serem atribuídas 
Output - Registro atualizado das competências do funcionário_
...
_Dar feedback claro sobre o resultado da atribuição de competências.
 Lidar com competências pré-existentes do funcionário durante a atribuição_
