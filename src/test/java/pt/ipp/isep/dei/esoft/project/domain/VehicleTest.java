...
public class VehicleTest {
    ...
    void testCreateVehicle() {
        Vehicle vehicle = new Vehicle("AB123CD", "Toyota", "Corolla", "Sedan", 1200, 1500,
                50000, LocalDate.of(2022,01,01), LocalDate.of(2022,01,01), 10000);
        ...
        assertEquals(LocalDate.of(2022,01,01), vehicle.getRegisterString());
        assertEquals(LocalDate.of(2022,01,01), vehicle.getAcquisitionString());
    ...
    public void testCreateVehicleWithInvalidRegisterDate() {
        assertThrows(IllegalArgumentException.class, () -> {
            Vehicle vehicle = new Vehicle("AB123CD", "Toyota", "Corolla", "Sedan", 1200, 1500,
                    50000, null, LocalDate.of(2022,01,01), 10000);
        });
    }
